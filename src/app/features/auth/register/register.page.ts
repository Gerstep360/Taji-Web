    ...
    <taji-auth-shell [wide]="true">
      ...
      <form class="auth-form" [formGroup]="form" (ngSubmit)="submit()" novalidate>
        ...
        <div class="form-grid">
          ...
          <taji-field label="Teléfono (opcional)" type="tel" icon="phone" placeholder="+591 70000000" autocomplete="tel" formControlName="phone" />
        </div>
        <div class="form-grid">
...
export class RegisterPage {
  ...
  fieldError(name: 'first_name' | 'last_name' | 'email' | 'password' | 'password_confirm'): string {
